...
<head>
    ...
    <title>models.Pokemon 007 | Squirtle</title>
...
<body>
    ...
    <section id="main-content">
        <div class="card">
            <h1>models.Pokemon #007</h1>
            <!-- models.Pokemon name and picture -->
            <h2>Squirtle, The Tiny Turtle models.Pokemon</h2>
            <img src="./images/squirtle.png" alt="Squirtle" class="poke-img">
            <br>
            <!-- Pokedex entry -->
            <p>
                "This Tiny Turtle models.Pokemon draws its long neck into its shell to launch incredible Water attacks with amazing range and accuracy. The blasts can be quite powerful."
            </p>
